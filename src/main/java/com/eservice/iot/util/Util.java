...
public class Util {
    ...
    public static Date getAttendanceBeginTime() {
        Calendar attendanceBegin = Calendar.getInstance();
        attendanceBegin.set(Calendar.HOUR_OF_DAY, 5);
    ...
    public static Date getAttendanceEndTime() {
        Calendar attendanceEnd = Calendar.getInstance();
        attendanceEnd.set(Calendar.HOUR_OF_DAY, 17);
        attendanceEnd.set(Calendar.MINUTE, 0);
        attendanceEnd.set(Calendar.SECOND, 0);
        attendanceEnd.set(Calendar.MILLISECOND, 0);
        return attendanceEnd.getTime();
    }
